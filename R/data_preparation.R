...
data_s <- read.xlsx("data_raw/Data_Spanische_Grippe_V2.xlsx",detectDates = TRUE) %>%
...
data_bern_wave <- read.xlsx("data_raw/Influenza_Bern_korrigiert.xlsx",detectDates = TRUE) %>%
...
save(data_bern_wave ,file=paste0("data/data_bern_wave.RData"))
write.xlsx(data_bern_wave,file=paste0("data/data_bern_wave.xlsx"),row.names=FALSE, overwrite = TRUE)
